...
(function() {
    ...
    QUnit.test("Testing soiIftyString", function(assert) {
        var test;
        var expectedResult;
        var actualResult;

        test = "Line1\rLine2\nLine3\r\nLine4";
        expectedResult = "Line1<br>Line2<br>Line3<br>Line4";
        actualResult = upgrades.chatroom.internal.soiIftyString(test);
        assert.deepEqual(actualResult, expectedResult, "Single newline translated");

        test = "Line1\r\rLine2\n\nLine3\r\n\r\nLine4";
        expectedResult = "Line1<p>Line2<p>Line3<p>Line4";
        actualResult = upgrades.chatroom.internal.soiIftyString(test);
        assert.deepEqual(actualResult, expectedResult, "Double newline translated");

        test = "<div>1<div 2><hr><hr >";
        expectedResult = 	"*1* 2>** >";
        actualResult = upgrades.chatroom.internal.soiIftyString(test);
