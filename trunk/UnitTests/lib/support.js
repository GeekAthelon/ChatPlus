...
(function() {
  document.body.removeEventListener('click', forbidNavigation, false);
  document.body.addEventListener('click', forbidNavigation, false);

  document.body.removeEventListener('click', forbidSubmit, false);
  document.body.addEventListener('click', forbidSubmit, false);
  ...
  function navAlert() {
    ...
    modalWindow.confirm("Demo page -- navigation disabled", buttons, function(answer) {});    
  }
  
  function forbidSubmit(e) {
    var el = e.target;
    while (el) {
	  if (el && el.tagName && el.tagName.toLowerCase() === "form") {
	    el.onsubmit = function() {navAlert(); return false;}
	  }
      el = el.parentNode;
    };
  }
  
  function forbidNavigation(e) {
    var el = e.target;
    var container = el;
    ...
    while (container && container.id !== 'qunit-fixture') {
